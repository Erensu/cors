...
static int encode_head(int type, rtcm_t *rtcm, int sys, int sync, int nsat)
{
    ...
    log_trace(4,"encode_head: type=%d sync=%d sys=%d nsat=%d\n",type,sync,sys,nsat);
...
static int encode_type1001(rtcm_t *rtcm, int sync)
{
    ...
    log_trace(3,"encode_type1001: sync=%d\n",sync);
...
static int encode_type1002(rtcm_t *rtcm, int sync)
{
    ...
    log_trace(3,"encode_type1002: sync=%d\n",sync);
...
static int encode_type1003(rtcm_t *rtcm, int sync)
{
    ...
    log_trace(3,"encode_type1003: sync=%d\n",sync);
...
static int encode_type1004(rtcm_t *rtcm, int sync)
{
    ...
    log_trace(3,"encode_type1004: sync=%d\n",sync);
...
static int encode_type1005(rtcm_t *rtcm, int sync)
{
    ...
    log_trace(3,"encode_type1005: sync=%d\n",sync);
...
static int encode_type1006(rtcm_t *rtcm, int sync)
{
    ...
    log_trace(3,"encode_type1006: sync=%d\n",sync);
    
    if (0.0<=rtcm->sta.hgt&&rtcm->sta.hgt<=6.5535) {
        hgt=ROUND(rtcm->sta.hgt/0.0001);
    }
    else {
        log_trace(2,"antenna height error: h=%.4f\n",rtcm->sta.hgt);
    }
...
static int encode_type1007(rtcm_t *rtcm, int sync)
{
    ...
    log_trace(3,"encode_type1007: sync=%d\n",sync);
...
static int encode_type1008(rtcm_t *rtcm, int sync)
{
    ...
    log_trace(3,"encode_type1008: sync=%d\n",sync);
...
static int encode_type1010(rtcm_t *rtcm, int sync)
{
    ...
    log_trace(3,"encode_type1010: sync=%d\n",sync);
...
static int encode_type1011(rtcm_t *rtcm, int sync)
{
    ...
    log_trace(3,"encode_type1011: sync=%d\n",sync);
...
static int encode_type1012(rtcm_t *rtcm, int sync)
{
    ...
    log_trace(3,"encode_type1012: sync=%d\n",sync);
...
static int encode_type1019(rtcm_t *rtcm, int sync)
{
    ...
    log_trace(3,"encode_type1019: sync=%d\n",sync);
...
static int encode_type1020(rtcm_t *rtcm, int sync)
{
    ...
    log_trace(3,"encode_type1020: sync=%d\n",sync);
...
static int encode_type1033(rtcm_t *rtcm, int sync)
{
    ...
    log_trace(3,"encode_type1033: sync=%d\n",sync);
...
static int encode_type1041(rtcm_t *rtcm, int sync)
{
    ...
    log_trace(3,"encode_type1041: sync=%d\n",sync);
...
static int encode_type1044(rtcm_t *rtcm, int sync)
{
    ...
    log_trace(3,"encode_type1044: sync=%d\n",sync);
...
static int encode_type1045(rtcm_t *rtcm, int sync)
{
    ...
    log_trace(3,"encode_type1045: sync=%d\n",sync);
...
static int encode_type1046(rtcm_t *rtcm, int sync)
{
    ...
    log_trace(3,"encode_type1046: sync=%d\n",sync);
...
static int encode_type1042(rtcm_t *rtcm, int sync)
{
    ...
    log_trace(3,"encode_type1042: sync=%d\n",sync);
...
static int encode_type63(rtcm_t *rtcm, int sync)
{
    ...
    log_trace(3,"encode_type63: sync=%d\n",sync);
                           ...
                           int provid, int solid)
{
    ...
    log_trace(4,"encode_ssr_head: type=%d sys=%d subtype=%d nsat=%d sync=%d iod=%d "
...
static int encode_ssr1(rtcm_t *rtcm, int sys, int subtype, int sync)
{
    ...
    log_trace(3,"encode_ssr1: sys=%d subtype=%d sync=%d\n",sys,subtype,sync);
...
static int encode_ssr2(rtcm_t *rtcm, int sys, int subtype, int sync)
{
    ...
    log_trace(3,"encode_ssr2: sys=%d subtype=%d sync=%d\n",sys,subtype,sync);
...
static int encode_ssr3(rtcm_t *rtcm, int sys, int subtype, int sync)
{
    ...
    log_trace(3,"encode_ssr3: sys=%d subtype=%d sync=%d\n",sys,subtype,sync);
...
static int encode_ssr4(rtcm_t *rtcm, int sys, int subtype, int sync)
{
    ...
    log_trace(3,"encode_ssr4: sys=%d subtype=%d sync=%d\n",sys,subtype,sync);
...
static int encode_ssr5(rtcm_t *rtcm, int sys, int subtype, int sync)
{
    ...
    log_trace(3,"encode_ssr5: sys=%d subtype=%d sync=%d\n",sys,subtype,sync);
...
static int encode_ssr6(rtcm_t *rtcm, int sys, int subtype, int sync)
{
    ...
    log_trace(3,"encode_ssr6: sys=%d subtype=%d sync=%d\n",sys,subtype,sync);
...
static int encode_ssr7(rtcm_t *rtcm, int sys, int subtype, int sync)
{
    ...
    log_trace(3,"encode_ssr7: sys=%d subtype=%d sync=%d\n",sys,subtype,sync);
                               ...
                               int nsat)
{
    ...
    for (j=0;j<nsat;j++) {
        if (rrng[j]==0.0) {
            ...
            log_trace(2,"msm rough range overflow %s rrng=%.3f\n",
...
static int encode_msm_rrate(rtcm_t *rtcm, int i, const double *rrate, int nsat)
{
    ...
    for (j=0;j<nsat;j++) {
        if (fabs(rrate[j])>8191.0) {
            log_trace(2,"msm rough phase-range-rate overflow %s rrate=%.4f\n",
...
static int encode_msm_psrng(rtcm_t *rtcm, int i, const double *psrng, int ncell)
{
    ...
    for (j=0;j<ncell;j++) {
        if (psrng[j]==0.0) {
            ...
            log_trace(2,"msm fine pseudorange overflow %s psrng=%.3f\n",
                               ...
                               int ncell)
{
    ...
    for (j=0;j<ncell;j++) {
        if (psrng[j]==0.0) {
            ...
            log_trace(2,"msm fine pseudorange ext overflow %s psrng=%.3f\n",
                 time_str(rtcm->time,0),psrng[j]);
            psrng_val=-524288;
        }
        else {
...
static int encode_msm_phrng(rtcm_t *rtcm, int i, const double *phrng, int ncell)
{
    ...
    for (j=0;j<ncell;j++) {
        if (phrng[j]==0.0) {
            ...
            log_trace(2,"msm fine phase-range overflow %s phrng=%.3f\n",
                               ...
                               int ncell)
{
    ...
    for (j=0;j<ncell;j++) {
        if (phrng[j]==0.0) {
            ...
            log_trace(2,"msm fine phase-range ext overflow %s phrng=%.3f\n",
                 time_str(rtcm->time,0),phrng[j]);
            phrng_val=-8388608;
        }
        else {
...
static int encode_msm_rate(rtcm_t *rtcm, int i, const double *rate, int ncell)
{
    ...
    for (j=0;j<ncell;j++) {
        if (rate[j]==0.0) {
            ...
            log_trace(2,"msm fine phase-range-rate overflow %s rate=%.3f\n",
...
static int encode_msm1(rtcm_t *rtcm, int sys, int sync)
{
    ...
    log_trace(3,"encode_msm1: sys=%d sync=%d\n",sys,sync);
...
static int encode_msm2(rtcm_t *rtcm, int sys, int sync)
{
    ...
    log_trace(3,"encode_msm2: sys=%d sync=%d\n",sys,sync);
...
static int encode_msm3(rtcm_t *rtcm, int sys, int sync)
{
    ...
    log_trace(3,"encode_msm3: sys=%d sync=%d\n",sys,sync);
...
static int encode_msm4(rtcm_t *rtcm, int sys, int sync)
{
    ...
    log_trace(3,"encode_msm4: sys=%d sync=%d\n",sys,sync);
...
static int encode_msm5(rtcm_t *rtcm, int sys, int sync)
{
    ...
    log_trace(3,"encode_msm5: sys=%d sync=%d\n",sys,sync);
...
static int encode_msm6(rtcm_t *rtcm, int sys, int sync)
{
    ...
    log_trace(3,"encode_msm6: sys=%d sync=%d\n",sys,sync);
...
static int encode_msm7(rtcm_t *rtcm, int sys, int sync)
{
    ...
    log_trace(3,"encode_msm7: sys=%d sync=%d\n",sys,sync);
...
static int encode_type1230(rtcm_t *rtcm, int sync)
{
    ...
    log_trace(3,"encode_type1230: sync=%d\n",sync);
...
extern int encode_rtcm3(rtcm_t *rtcm, int type, int subtype, int sync)
{
    ...
    log_trace(3,"encode_rtcm3: type=%d subtype=%d sync=%d\n",type,subtype,sync);
